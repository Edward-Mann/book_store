 ...
 * Provides endpoints for user registration, profile management, and administrative customer operations.
 * Handles both public registration endpoints and secured user/admin endpoints.
 */
@RestController
@RequestMapping("/api")
@Validated
public class CustomerController {
    ...
    /**
     * Constructs a new CustomerController with the required dependencies.
     *
    ...
    public ResponseEntity<ApiResponse<CustomerDto>> upgradeToAdmin(@PathVariable("userId") @Positive(message = "Customer ID must be positive") Long userId) {
    ...
    public ResponseEntity<ApiResponse<CustomerDto>> getCustomerById(@PathVariable("id") @Positive(message = "Customer ID must be positive") Long id) {
    ...
    public ResponseEntity<ApiResponse<CustomerDto>> deleteCustomer(@PathVariable("id") @Positive(message = "Customer ID must be positive") Long id) {
        customerService.deleteCustomer(id);
        return ResponseEntity.ok(ApiResponse.success("Customer deleted successfully", null));
    }

    /**
     * Helper method to retrieve and validate the current authenticated user.
     *
     * @return the authentication context for the current user
