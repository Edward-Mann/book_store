...
public class BookController {
    ...
    /**
     * Constructs a new BookController with the required dependencies.
     *
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<BookDto>> getBook(@PathVariable("id") @Positive(message = "Book ID must be positive") Long id) {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @DeleteMapping("/{id}")
    public ResponseEntity<ApiResponse<BookDto>> deleteBook(@PathVariable("id") @Positive(message = "Book ID must be positive") Long id) {
